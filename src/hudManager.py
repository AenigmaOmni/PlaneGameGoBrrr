...
class HudManager:
    ...
    def load(self, player):
        ...
        self.wave_font = pygame.font.SysFont(None, 40)
        self.update(player)
    
    def update(self, player):
        self.hp_text = self.hp_font.render("ARMOR: " + str(player.hp) + "/10", True, (255,255,255))
        self.wave_text = self.wave_font.render("WAVE: " + str(player.onWave), True, (255,255,255))
    ...
    def render(self, surface):
        ...
        surface.blit(self.wave_text, (WINDOW_WIDTH / 2 - 100, 10))